...
int data_6Pr[6]; 
int data_7Pr[6]; 
int data_3Pr_1Pr[5] = {3, 33, 333, 3333, 1}; 
int data_3Pr_2Pr[5] = {3, 33, 333, 3333, 2}; 
int data_3Pr_4Pr[5] = {3, 33, 333, 3333, 4}; 
int data_3Pr_5Pr[5] = {3, 33, 333, 3333, 5}; 
int data_3Pr_6Pr[5] = {3, 33, 333, 3333, 6}; 
int data_3Pr_7Pr[5] = {3, 33, 333, 3333, 7}; 
int data[8]; 
...
void Sensor(){
  ...
  loadvoltage = busvoltage + (shuntvoltage / 1000);
    ...
    data_3Pr_1Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_3Pr_1Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_3Pr_1Pr[3] = power_mW; // мощность на 1-ом генераторе

    data_3Pr_2Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_3Pr_2Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_3Pr_2Pr[3] = power_mW; // мощность на 1-ом генераторе

    data_3Pr_4Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_3Pr_4Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_3Pr_4Pr[3] = power_mW; // мощность на 1-ом генераторе

    data_3Pr_5Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_3Pr_5Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_3Pr_5Pr[3] = power_mW; // мощность на 1-ом генераторе

    data_3Pr_6Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_3Pr_6Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_3Pr_6Pr[3] = power_mW; // мощность на 1-ом генераторе

    data_3Pr_7Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_3Pr_7Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_3Pr_7Pr[3] = power_mW; // мощность на 1-ом генераторе
}
...
void Cloud_Send(String fro, int cur, int vol, int cap) {
  ...
  Serial.println(url);
  client_secure.print(String("GET ") + "/macros/s/AKfycbzhY25bX21xMJBjRnIBKkrPkyvZK1vxhSlq40GGVh3YmetP0Sqw" + url + " HTTP/1.1\r\n" +
         "Host: " + host + "\r\n" +
      ...
      Serial.print(" "); 
        ...
        while(true){
          ...
          if(radio.write(&teleTo, sizeof(teleTo))){
            ...
            radio.closeReadingPipe(1); 
            Serial.println("Отправил ответный 2-му!"); 
            break; 
          }
          delay(25); 
        } 
...
void TransLoop(){
  while(Flag_2Pr){
      ...
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_3Pr_2Pr, sizeof(data_3Pr_2Pr), true);
  ...
  while(Flag_1Pr){
      radio.openWritingPipe(address[1]); 
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_3Pr_1Pr, sizeof(data_3Pr_1Pr), true);
   ...
   while(Flag_5Pr){
      radio.openWritingPipe(address[1]); 
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_3Pr_5Pr, sizeof(data_3Pr_5Pr), true);
   ...
   while(Flag_6Pr){
      radio.openWritingPipe(address[1]); 
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_3Pr_6Pr, sizeof(data_3Pr_6Pr), true);
   ...
   while(Flag_7Pr){
      radio.openWritingPipe(address[1]); 
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_3Pr_7Pr, sizeof(data_3Pr_7Pr), true);
  ...
  while(Flag_4Pr){
      radio.openWritingPipe(address[1]); 
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_3Pr_4Pr, sizeof(data_3Pr_4Pr), true);
