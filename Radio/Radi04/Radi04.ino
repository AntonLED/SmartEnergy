...
int data_6Pr[6]; 
int data_7Pr[6]; 
int data_4Pr_1Pr[5] = {4, 44, 444, 4444, 1};
int data_4Pr_2Pr[5] = {4, 44, 444, 4444, 2}; 
int data_4Pr_3Pr[5] = {4, 44, 444, 4444, 3}; 
int data_4Pr_5Pr[5] = {4, 44, 444, 4444, 5};  
int data_4Pr_6Pr[5] = {4, 44, 444, 4444, 6}; 
int data_4Pr_7Pr[5] = {4, 44, 444, 4444, 7}; 
int data[8]; 
...
void Sensor(){
  ...
  loadvoltage = busvoltage + (shuntvoltage / 1000);
    ...
    data_4Pr_1Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_4Pr_1Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_4Pr_1Pr[3] = power_mW; // мощность на 1-ом генераторе

    data_4Pr_2Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_4Pr_2Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_4Pr_2Pr[3] = power_mW; // мощность на 1-ом генераторе

    data_4Pr_3Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_4Pr_3Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_4Pr_3Pr[3] = power_mW; // мощность на 1-ом генераторе

    data_4Pr_5Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_4Pr_5Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_4Pr_5Pr[3] = power_mW; // мощность на 1-ом генераторе

    data_4Pr_6Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_4Pr_6Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_4Pr_6Pr[3] = power_mW; // мощность на 1-ом генераторе

    data_4Pr_7Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_4Pr_7Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_4Pr_7Pr[3] = power_mW; // мощность на 1-ом генераторе
}
...
void TransLoop(){
   while(Flag_1Pr){
      ...
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_4Pr_1Pr, sizeof(data_4Pr_1Pr), true);
   ...
   while(Flag_2Pr){
      radio.openWritingPipe(address[1]); 
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_4Pr_2Pr, sizeof(data_4Pr_2Pr), true);
  ...
  while(Flag_3Pr){
      radio.openWritingPipe(address[1]); 
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_4Pr_3Pr, sizeof(data_4Pr_3Pr), true);
  ...
  while(Flag_6Pr){
      radio.openWritingPipe(address[1]); 
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_4Pr_6Pr, sizeof(data_4Pr_6Pr), true);
  ...
  while(Flag_7Pr){
      radio.openWritingPipe(address[1]); 
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_4Pr_7Pr, sizeof(data_4Pr_7Pr), true);
  ...
  while(Flag_5Pr){
      radio.openWritingPipe(address[1]); 
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_4Pr_5Pr, sizeof(data_4Pr_5Pr), true);
