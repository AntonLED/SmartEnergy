...
int data_6Pr[6]; 
int data_7Pr[6]; 
int data_2Pr_1Pr[5] = {2, 22, 222, 2222, 1};
int data_2Pr_3Pr[5] = {2, 22, 222, 2222, 3};  
int data_2Pr_4Pr[5] = {2, 22, 222, 2222, 4}; 
int data_2Pr_5Pr[5] = {2, 22, 222, 2222, 5}; 
int data_2Pr_6Pr[5] = {2, 22, 222, 2222, 6}; 
int data_2Pr_7Pr[5] = {2, 22, 222, 2222, 7}; 
int data[8]; 
...
void Sensor(){
  ...
  loadvoltage = busvoltage + (shuntvoltage / 1000);
    ...
    data_2Pr_1Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_2Pr_1Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_2Pr_1Pr[3] = power_mW; // мощность на 1-ом генераторе

    data_2Pr_3Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_2Pr_3Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_2Pr_3Pr[3] = power_mW; // мощность на 1-ом генераторе

    data_2Pr_4Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_2Pr_4Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_2Pr_4Pr[3] = power_mW; // мощность на 1-ом генераторе

    data_2Pr_5Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_2Pr_5Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_2Pr_5Pr[3] = power_mW; // мощность на 1-ом генераторе

    data_2Pr_6Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_2Pr_6Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_2Pr_6Pr[3] = power_mW; // мощность на 1-ом генераторе

    data_2Pr_7Pr[1] = current_mA; //сила тока на 1-ом генераторе
  data_2Pr_7Pr[2] = loadvoltage; //напряжение на 1-ом генераторе
  data_2Pr_7Pr[3] = power_mW; // мощность на 1-ом генераторе
}
...
void TransLoop(){
   while(Flag_1Pr){
      ...
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_2Pr_1Pr, sizeof(data_2Pr_1Pr), true);
   ...
   while(Flag_4Pr){
      radio.openWritingPipe(address[1]); 
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_2Pr_4Pr, sizeof(data_2Pr_4Pr), true);
  ...
  while(Flag_5Pr){
      radio.openWritingPipe(address[1]); 
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_2Pr_5Pr, sizeof(data_2Pr_5Pr), true);
  ...
  while(Flag_6Pr){
      radio.openWritingPipe(address[1]); 
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_2Pr_6Pr, sizeof(data_2Pr_6Pr), true);
  ...
  while(Flag_7Pr){
      radio.openWritingPipe(address[1]); 
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_2Pr_7Pr, sizeof(data_2Pr_7Pr), true);
  ...
  while(Flag_3Pr){
      radio.openWritingPipe(address[1]); 
      radio.stopListening();  //не слушаем радиоэфир, мы передатчик
      radio.write(&data_2Pr_3Pr, sizeof(data_2Pr_3Pr), true);
