...
byte myPriority = 4; // для хранения приоритета данного модуля
...
void Priority(){
  power_1Gen = dataSystem[6][2]; 
  
  power_2Gen = dataSystem[6][2];
  
  batteryStat = dataSystem[5][2];

  allPower = power_1Gen + power_2Gen; 
